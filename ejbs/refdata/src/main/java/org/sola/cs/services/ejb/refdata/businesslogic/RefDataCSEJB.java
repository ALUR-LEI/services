package org.sola.cs.services.ejb.refdata.businesslogic;
 ...
 */
@Stateless
@EJB(name = "java:app/RefDataCSEJBLocal", beanInterface = RefDataCSEJBLocal.class)
public class RefDataCSEJB extends AbstractEJB implements RefDataCSEJBLocal {
